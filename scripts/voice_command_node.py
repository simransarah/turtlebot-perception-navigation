...
class VoiceCommandNode:
    ...
    def recognized_cb(self, evt):
        ...
        if evt.result.reason == speechsdk.ResultReason.RecognizedSpeech:
            ...
            # not case sensitive
            if 'go forward' in recognized_text:
                message = 'go forward'
            elif 'go back' in  recognized_text:
                message = 'go back'
            ...
            elif 'centre on' in recognized_text:
                index = recognized_text.find('centre on')
                message = recognized_text[index:]
            else:
